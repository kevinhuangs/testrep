...
/opt/java6/bin/java -Dfile.encoding=GBK -Xms1536m -Xmx1536m -classpath $CLASSPATH com.ceb.ibs.BatchExecute $YESTODAY $NEXTDAY $INDEXS
#java -classpath $CLASSPATH com.ceb.ibs.BatchExecute $YESTODAY $NEXTDAY $INDEXS
