...
/opt/java6/bin/java -classpath $CLASSPATH com.ceb.ibs.ValidStaticsBatch $YESTODAY $NEXTDAY
#java -classpath $CLASSPATH com.ceb.ibs.ValidStaticsBatch $YESTODAY $NEXTDAY 
