...
#增加全量 IBS_PTAB_JNL_CREDITCARDAPPLY(信用卡申请流水)    20130506              当日全量
spool /backup/batchdir/shells/data/all_log/2173IBS_PTAB_JNL_CREDITCARDAPPLY.log
set trimspool on
select '*****'||to_char(sysdate,'yyyyMMdd hh24:mi:ss')||' STEP处理开始(IBS_PTAB_JNL_CREDITCARDAPPLY全量导出) IBS_PTAB_JNL_CREDITCARDAPPLY*****' from dual;
spool off
@IBS_PTAB_JNL_CREDITCARDAPPLY20130530.sql
spool /backup/batchdir/shells/data/all_log/2174IBS_PTAB_JNL_CREDITCARDAPPLY.log
set trimspool on
select '*****'||to_char(sysdate,'yyyyMMdd hh24:mi:ss')||' STEP处理结束(IBS_PTAB_JNL_CREDITCARDAPPLY全量导出) IBS_PTAB_JNL_CREDITCARDAPPLY*****' from dual;
spool off
#end by 20130506
