...
#增加全量 IBS_PTAB_JNL_CYCLEPAY(资金归集日志表)    20130328              初始全量
spool /backup/batchdir/shells/data/all_log/2173IBS_PTAB_JNL_CYCLEPAY.log
set trimspool on
select '*****'||to_char(sysdate,'yyyyMMdd hh24:mi:ss')||' STEP处理开始(IBS_PTAB_JNL_CYCLEPAY全量导出) IBS_PTAB_JNL_CYCLEPAY*****' from dual;
spool off
@IBS_PTAB_JNL_CYCLEPAY20130328.sql
spool /backup/batchdir/shells/data/all_log/2174IBS_PTAB_JNL_CYCLEPAY.log
set trimspool on
select '*****'||to_char(sysdate,'yyyyMMdd hh24:mi:ss')||' STEP处理结束(IBS_PTAB_JNL_CYCLEPAY全量导出) IBS_PTAB_JNL_CYCLEPAY*****' from dual;
spool off


#增加全量 IBS_PTAB_JNL_FINANCING(融资通日志表)    20130328              初始全量
spool /backup/batchdir/shells/data/all_log/2175IBS_PTAB_JNL_FINANCING.log
set trimspool on
select '*****'||to_char(sysdate,'yyyyMMdd hh24:mi:ss')||' STEP处理开始(IBS_PTAB_JNL_FINANCING全量导出) IBS_PTAB_JNL_FINANCING*****' from dual;
spool off
@IBS_PTAB_JNL_FINANCING20130328.sql
spool /backup/batchdir/shells/data/all_log/2176IBS_PTAB_JNL_FINANCING.log
set trimspool on
select '*****'||to_char(sysdate,'yyyyMMdd hh24:mi:ss')||' STEP处理结束(IBS_PTAB_JNL_FINANCING全量导出) IBS_PTAB_JNL_FINANCING*****' from dual;
spool off


#增加全量 IBS_PTAB_JNL_FINANCING(融资通日志表)    20130328              初始全量
spool /backup/batchdir/shells/data/all_log/2177IBS_PTAB_JNL_LOANPAYOFF_STARTTIME.log
set trimspool on
select '*****'||to_char(sysdate,'yyyyMMdd hh24:mi:ss')||' STEP处理开始(IBS_PTAB_JNL_LOANPAYOFF全量导出) IBS_PTAB_JNL_LOANPAYOFF*****' from dual;
spool off
@IBS_PTAB_JNL_LOANPAYOFF20130328.sql
spool /backup/batchdir/shells/data/all_log/2178IBS_PTAB_JNL_LOANPAYOFF_ENDTIME.log
set trimspool on
select '*****'||to_char(sysdate,'yyyyMMdd hh24:mi:ss')||' STEP处理结束(IBS_PTAB_JNL_LOANPAYOFF全量导出) IBS_PTAB_JNL_LOANPAYOFF*****' from dual;
spool off
#end by 20130328
