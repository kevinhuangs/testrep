...
#自定义变量
DATANAME=T_EB_NPP_AERAINFO_${TODAY}.txt
DATA=${DATAPATH}/T_EB_NPP_AERAINFO_${TODAY}.txt
CTL=${CTLPATH}/INTOAERAINFO.ctl
COUNTSQL=${SQLPATH}/CountAeraInfoTemp.sql
TABLEMAME=IBS_TAB_FEE_AERAINFO_TMP
SYNSQL=${SQLPATH}/SynAeraInfo.sql
SHNAME=SynAeraInfo.sh
