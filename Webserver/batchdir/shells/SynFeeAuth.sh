...
#自定义变量
DATANAME=T_EB_NPP_AUTH_${TODAY}.txt
DATA=${DATAPATH}/T_EB_NPP_AUTH_${TODAY}.txt
CTL=${CTLPATH}/INTOFEEAUTH.ctl
COUNTSQL=${SQLPATH}/CountFeeAuthTemp.sql
TABLEMAME=IBS_TAB_FEE_AUTH_TMP
SYNSQL=${SQLPATH}/SynFeeAuth.sql
SHNAME=SynFeeAuth.sh
