...
#自定义变量
DATANAME=T_EB_NPP_ECCXBUSI_${TODAY}.txt
DATA=${DATAPATH}/T_EB_NPP_ECCXBUSI_${TODAY}.txt
CTL=${CTLPATH}/INTOFEEECCXBUSI.ctl
COUNTSQL=${SQLPATH}/CountFeeEccxBusiTemp.sql
TABLEMAME=IBS_TAB_FEE_ECCXBUSI_TMP
SYNSQL=${SQLPATH}/SynFeeEccxBusi.sql
SHNAME=SynFeeEccxBusi.sh
