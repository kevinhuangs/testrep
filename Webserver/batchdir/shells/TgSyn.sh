...
/opt/java6/bin/java -Xms1024m -Xmx1024m -classpath $CLASSPATH com.ceb.ibs.TgCustmerAddActionStart
/opt/java6/bin/java -Xms1024m -Xmx1024m -classpath $CLASSPATH com.ceb.ibs.TgAccountAddActionStart
/opt/java6/bin/java -Xms1024m -Xmx1024m -classpath $CLASSPATH com.ceb.ibs.TgAssetAddActionStart