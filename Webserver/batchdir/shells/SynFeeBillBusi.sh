...
#自定义变量
DATANAME=T_EB_NPP_BILLBUSI_${TODAY}.txt
DATA=${DATAPATH}/T_EB_NPP_BILLBUSI_${TODAY}.txt
CTL=${CTLPATH}/INTOFEEBILLBUSI.ctl
COUNTSQL=${SQLPATH}/CountFeeBillBusiTemp.sql
TABLEMAME=IBS_TAB_FEE_BILLBUSI_TMP
SYNSQL=${SQLPATH}/SynFeeBillBusi.sql
SHNAME=SynFeeBillBusi.sh
